...
test_parser.add_argument('--model-dir', type=str, default= '../Models/new-test/model_epoch_best.pth', help='Model directory')
...
if __name__ =='__main__':
        ...
        if test_args.GNN == 'MG-GNN':
            model = MGGNN(lvl=3, dim_embed=128, num_layers=1, K=2, ratio=0.2, lr=1e-4)
